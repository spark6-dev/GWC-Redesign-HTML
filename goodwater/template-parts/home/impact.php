<div class="gwc impact">
    <div class="container container--full">
        <div class="impact__head"> 
            ...
            if($link):?>
                <a class="l-btn l-btn--dark is--mobile" href="<?php echo $link['url'];?>" title="<?php echo $link['title'];?>"><?php echo $link['title'];?><i> <svg width="11" height="11" viewbox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="impact__title">
            ...
            if($link):?>
                <a class="l-btn l-btn--light-blue" href="<?php echo $link['url'];?>" title="<?php echo $link['title'];?>"><?php echo $link['title'];?>
