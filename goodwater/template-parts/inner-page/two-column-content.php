        ...
        <div class="consumer__wrap"> 
            ...
            if( get_field('right_content') || get_field('cta')):?>
                <div class="consumer__col">
                    ...
                    $link = get_field('cta');
                    if( $link ):?>
                        <a class="l-btn l-btn--dark mt-33" href="<?php echo $link['url'];?>" title="<?php echo $link['title'];?>"><?php echo $link['title'];?><i> <svg width="11" height="11" viewbox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
