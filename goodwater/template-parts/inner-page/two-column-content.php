        ...
        <div class="consumer__wrap"> 
            ...
            if( get_field('right_content') || get_field('cta')):?>
                <div class="consumer__col">
                    ...
                    $link = get_field('cta');
                    if( $link ):?>
                        <a class="l-btn l-btn--dark mt-33 <?php echo $button_on_left ? "medium-up-hide": ""?>" href="<?php echo $link['url'];?>" title="<?php echo $link['title'];?>"><?php echo $link['title'];?><i> <svg width="11" height="11" viewbox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M1.21047 1.17139H9.41407M9.41407 1.17139L9.17486 9.3715M9.41407 1.17139L0.500392 9.82837" stroke="white" stroke-width="1.25"></path>
                      </svg></i></a>
                    <?php endif;?>
                </div>
