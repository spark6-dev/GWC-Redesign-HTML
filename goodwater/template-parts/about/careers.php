<section class="section section--career">
    ...
    <div class="gwc opportunities opportunities--about">
        <div class="container">
            <?php if( get_field('career_bottom_text') ):?>
                <h2><?php echo esc_html(get_field('career_bottom_text'));?></h2>
            <?php endif;
            $link = get_field('career_bottom_link');
            if($link):?>
                <div class="opportunities__btn"><a class="l-btn l-btn--dark" href="<?php echo $link['url'];?>" title="<?php echo $link['title'];?>"><?php echo $link['title'];?><i> 
